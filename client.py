...
# Helper function to handle corrupted packets


def handleCorruptPacket(address):
    failString = "Client receieved a corrupt packet"
    packet = createPacket(0, 0, failString)
